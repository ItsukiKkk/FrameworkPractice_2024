...
<body>
<center>
<form action="ShopServlet?flag=queryOrder" method="post">
...
<form action="ShopServlet?flag=queryShop" method="post">
	...
	<div style="height:100%; width:100%;">
		<c:forEach var="shopInfo" items="${shopInfoList }">
			<div style="float:left; height:100px; width:100px;">
				...
				<a href="ShopServlet?flag=intoCar&shopId=${shopInfo.shopId}">加入购物车</a>
			</div>
